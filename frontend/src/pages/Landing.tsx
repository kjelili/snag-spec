...
import { ArrowRight, ShieldCheck, Sparkles, TimerReset, BarChart3 } from 'lucide-react'
          ...
          <section className="space-y-8">
            ...
            <div className="space-y-5">
              ...
              <p className="max-w-2xl text-lg leading-relaxed text-slate-200">
                Manage snags, generate instructions, and keep decision trails clean. Designed to feel fast,
                clear, and dependable across desktop, tablet, and mobile.
              </p>
            </div>
